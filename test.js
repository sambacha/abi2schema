...
test("ERC20", { objectPrintDepth: 20 }, function (t) {
  ...
  t.deepEqual(
    actual,
    expected,
    "Converts all function inputs and outputs without options"
  );
  ...
  t.deepEqual(
    actual2,
    expected2,
    "Converts all function inputs and outputs as object"
  );
  ...
  t.deepEqual(
    actual4,
    expected4,
    "Converts all function outputs only as array"
  );
...
test("AllowanceCrowdsale", { objectPrintDepth: 20 }, function (t) {
  ...
  t.deepEqual(
    actual,
    expected,
    "Converts constructor function inputs as object"
  );
  const actual2 = convert(abi, {
    as: "object",
    for: "inputs",
  ...
  t.deepEqual(
    actual2,
    expected,
    "Converts constructor function inputs when specified as type"
  );
  ...
  t.deepEqual(
    actual3,
    expected3,
    "Converts constructor function inputs to array"
  );
